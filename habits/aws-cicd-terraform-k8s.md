...
## 
# Gun 35
## aws consile uzerinden 4 yolla ec2 instanceya baglanmaq olar ec2 instance connect, ssh session manager ssh client ec2 serial console(ssm ucun 3 (3 policy attach olunmali)
